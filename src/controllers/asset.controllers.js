...
const getAssetById = asyncHandler(async (req, res) => {
    ...
    let qrObject = asset.toObject()

    delete qrObject.invoiceImage
    delete qrObject.productImage
    delete qrObject.createdBy
    delete qrObject.createdAt
    delete qrObject.updatedAt

    // console.log(qrObject)

    

    let qrCode = await generateQRCode(qrObject)
