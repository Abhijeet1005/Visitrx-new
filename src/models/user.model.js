...
const userSchema = new  Schema({
    ...
    role: {
        type: String,
        enum: ["Employee","AssetAdmin","SecurityAdmin","AppAdmin","AccountsHead","ITHead", "SalesHead","DigitalMangatramHead","PMJMastersHead","StockHead","TitanHead"], // We can add more xxAdmin and xxEmployee values
        default: "Employee"
    },
